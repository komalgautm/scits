...
class TrainingController extends Controller
{
    public function index(){
        ...
        // $list_training = Training::where('home_id',Auth::user()->home_id)->where('training_year',$year)->where('is_deleted', '0')->orderBy('training_month','asc')->get()->toArray();
           $list_training = Training::where('home_id',Auth::user()->home_id)->where('training_year',$year)->where('is_deleted', '0')->orderBy('training_month','asc')->get(); 
        if(count($list_training)>0){
        ...
        return View::make('frontEnd.staffManagement.training_listing',$data);
