              ...
              <aside class="right-side-info">
                ...
                <div class="tab-content" id="myTabContent">
                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="tab-first-infos"><h3><a href="{{ url('absence/type=1') }}">Request time off</a></h3></div>
            ...
            <div class="row my-3">
              ...
              <div class="col-md-4 my-2">
                <div class="card">
                  ...
                  <div class="detail">
                    <div class="headline">
                      <p>Manage payroll to get employee payments right and maintain compliance with HMRC legislation.</p>
                    </div>
                    <div class="more-headline">
                      <p>Stores all your employee salaries and wages in one place, alongside tax codes and National Insurance numbers. You can also run regular payroll reports, giving you information to enter into your payroll system or to send to your accountant.  <span class="see-more-card"><a href="#" style="text-decoration: none;">See More</a></span></p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-4 my-2">
                <div class="card">
                  ...
                  <div class="detail">
                    ...
                    <div class="more-headline">
                      <p>Add details of job applicants, store key documents securely, and track applicant's stages in the recruitment process.  <span class="see-more-card"><a href="#" style="text-decoration: none;">See More</a></span></p>
                    </div>
                  </div>
                </div>
              <!-- </div>
